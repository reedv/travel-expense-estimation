...
<head>
  ...
  <title>Starting a Django Project the Right Way</title>
  <meta name="author" content="Jeff Knupp">
  <meta name="description" content="Starting a Django Project the Right Way"> 
  <link rel="shortcut icon" href="/images/favicon.png" >
  <link rel="canonical" href="https://jeffknupp.com/blog/2012/02/09/starting-a-django-project-the-right-way/" >
  <link rel="alternate" href="http://feeds.feedblitz.com/hackersgonnahack" title="Python Programming" type="application/atom+xml">
  <meta property="og:url"                content="https://jeffknupp.com/blog/2012/02/09/starting-a-django-project-the-right-way/" />
  <meta property="og:type"               content="article" />
  <meta property="og:title"              content="Starting a Django Project the Right Way" />
  <meta property="og:description"        content="Starting a Django Project the Right Way" />
  <meta property="og:image"              content="https://jeffknupp.com/images/wip3_logo.png" />
  <meta property="fb:app_id"             content="229040610856657" />
...
src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
  ...
  (adsbygoogle = window.adsbygoogle || []).push({
              google_ad_client: "ca-pub-2922325862575361",
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.8&appId=229040610856657";
...
<header id="header">
    ...
    <nav>
        <a href="/">BLOG</a>
        <span itemprop="author" itemscope itemtype="http://schema.org/Person"><a itemprop="url" href="/about-me/">ABOUT</a></span>
        <a href="/blog/archives">ARCHIVES</a>
        <a href="/python-tutoring" title="python-tutoring">TUTORING</a>
        <a href="https://jeffknupp.com/writing-idiomatic-python-ebook/">BOOK</a>
    </nav>
</header>
<div class="container-fluid content">
    ...
    <div class="col-md-6 col-md-offset-3 col-xs-12">
        ...
        <div class="bs-callout bs-callout-info">
            <h4 class="text-center">Discuss Posts With Other Readers at <strong><a href="https://discourse.jeffknupp.com">discourse.jeffknupp.com</a></strong>!</h4>
        </div>
...
<header>
    <h1 class="post-title"><a href="/blog/2012/02/09/starting-a-django-project-the-right-way"><span itemprop="headline">Starting a Django Project the Right Way</span></a><br/>
</header>

<div class="entry-content" itemprop="articleBody">
    
        <h1>Using Django 1.6?</h1>
<p><strong><a href="http://www.jeffknupp.com/blog/2013/12/18/starting-a-django-16-project-the-right-way/">Check out the new, updated version of this post with Django 1.6 specific changes and updates</a>.</strong> </p>
<p>One of the things I wish I had known when starting my Django project for
...
<div class="codehilite"><pre><span class="mi">1</span><span class="p">.</span> <span class="nx">A</span> <span class="nx">fully</span> <span class="nx">functional</span> <span class="nx">Django</span> <span class="nx">project</span>
<span class="mi">2</span><span class="p">.</span> <span class="nx">All</span> <span class="nx">resources</span> <span class="nx">under</span> <span class="nx">source</span> <span class="nx">control</span> <span class="p">(</span><span class="kd">with</span> <span class="nx">git</span><span class="p">)</span>
<span class="mi">3</span><span class="p">.</span> <span class="nx">An</span> <span class="nx">environment</span> <span class="nx">independent</span> <span class="nx">install</span> <span class="nx">of</span> <span class="nx">your</span> <span class="nx">project</span> <span class="p">(</span><span class="nx">using</span> <span class="nx">virtualenv</span><span class="p">)</span>
<span class="mi">4</span><span class="p">.</span> <span class="nx">Automated</span> <span class="nx">deployment</span> <span class="nx">and</span> <span class="nx">testing</span> <span class="p">(</span><span class="nx">using</span> <span class="nx">Fabric</span><span class="p">)</span>
<span class="mi">5</span><span class="p">.</span> <span class="nx">Automatic</span> <span class="nx">database</span> <span class="nx">migrations</span> <span class="p">(</span><span class="nx">using</span> <span class="nx">South</span><span class="p">)</span>
<span class="mi">6</span><span class="p">.</span> <span class="nx">A</span> <span class="nx">solid</span> <span class="nx">start</span> <span class="nx">to</span> <span class="nx">your</span> <span class="k">new</span> <span class="nx">site</span>
</pre></div>
...
<div class="codehilite"><pre><span class="nv">$ </span>virtualenv env
</pre></div>


<p>or, if virtualenv isn't in your $PATH (though it should be):</p>
<div class="codehilite"><pre><span class="nv">$ </span>python virtualenv.py --distribute env
</pre></div>
...
so:</p>
<div class="codehilite"><pre><span class="nv">$ </span><span class="nb">source</span> ./env/bin/activate
</pre></div>
...
<div class="codehilite"><pre><span class="nv">$ </span>git commit -a -m <span class="s1">&#39;Initial commit of myproject&#39;</span>
</pre></div>
...
under our main directory. That's because, to this point, <em>there isn't
anything we don't want to commit</em>. Let's commit our changes using:</p>
<div class="codehilite"><pre><span class="nv">$ </span>git commit -a -m <span class="s1">&#39;Added South for database migrations&#39;</span>
</pre></div>
...
<div class="codehilite"><pre><span class="nv">$ </span>git clone /path/to/my/project/
</pre></div>
...
<div class="codehilite"><pre><span class="kn">from</span> <span class="nn">fabric.api</span> <span class="kn">import</span> <span class="n">lcd</span>
...
Simple. Just run:</p>
<div class="codehilite"><pre><span class="nv">$ </span>fab prepare_deployment:&lt;your_branch_name&gt;
...
<small>Posted on <time datetime="2012-02-09 09:13:00" pubdate data-updated="true" itemprop="datePublished">Feb 09, 2012</time> by <span itemprop="author"> Jeff Knupp</span></small> </h1>
    <div class="row">
            <div class="col-md-3"><div><a href="https://twitter.com/share" class="twitter-share-button" data-size="large" data-show-count="false">Tweet</a><script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script></div></div>
            <!--Facebook +! -->
            <div class="col-md-3 pull-right">
                <div class="fb-like" data-href="https://jeffknupp.com/blog/2012/02/09/starting-a-django-project-the-right-way" data-layout="standard" data-action="like" data-size="large" data-show-faces="true" data-share="true"></div>
            </div>
    </div>
<div class="bs-callout bs-callout-info">
    <h4 class="text-center">Discuss Posts With Other Readers at <strong><a href="https://discourse.jeffknupp.com">discourse.jeffknupp.com</a></strong>!</h4>
...
<div class="sharing">
    ...
    <a class="basic-alignment left" href="/blog/2012/02/08/building-your-second-django-site" title="Previous Post: Building Your Second Django Site">&laquo; Building Your Second Django Site</a>
    </p>
    
    <div id="mc_embed_signup" class="well">
<form action="https://jeffknupp.us6.list-manage1.com/subscribe/post?u=51d2d98cf34cbcc20db22e5fa&amp;id=f15bb537ad" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
...
<script type="text/javascript">
        ...
        <div id="footer" class="text-center">
            ...
            <footer role="contentinfo">
                <p>Copyright &copy; 2014 - Jeff Knupp- <span class="credit">Powered by <a href="https://www.github.com/jeffknupp/blug">Blug</a></span> </p>
            </footer>
         
    </div>

<a title="Web Analytics" href="https://clicky.com/66535137"><img alt="Web Analytics" src="//static.getclicky.com/media/links/badge.gif" border="0" /></a>
<script type="text/javascript">
